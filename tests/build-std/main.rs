    ...
    p.cargo("build")
        ...
        .with_stderr(
            "[UPDATING] git repository `https://github.com/solana-labs/compiler-builtins`\n\
             warning: Patch `compiler_builtins v0.1.95 (https://github.com/solana-labs/compiler-builtins?tag=solana-tools-v1.39#44fe1368)` was not used in the crate graph.\n\
